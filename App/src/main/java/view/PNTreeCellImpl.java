...
public class PNTreeCellImpl extends TreeCell<PNTreeItemElement> {
    ...
    public PNTreeCellImpl(EventHandler<? super MouseEvent> listener) {
    ...
    @Override
    public void updateItem(PNTreeItemElement item, boolean empty) {
    ...
    private void createTextField() {
        ...
        textField.setOnKeyReleased(t -> {
            if (t.getCode() == KeyCode.ENTER) {
                ...
                PNTreeItemElement PTreeElement = getItem();
