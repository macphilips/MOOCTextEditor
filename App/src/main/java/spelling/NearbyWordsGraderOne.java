...
public class NearbyWordsGraderOne {
    public static void main(String args[]) {
        ...
        try {
            ...
            feedback += "** TextStyleInfo 1: distanceOne list size... ";
            feedback += "distanceOne returned " + d1.size() + " words.\n";

            feedback += "** TextStyleInfo 2: distanceOne words returned... ";
            for (String i : d1) {
                feedback += i + ", ";
            }

            feedback += "\n** TextStyleInfo 3: distanceOne list size (allowing non-words)... ";
            d1 = nw.distanceOne("word", false);
            feedback += "distanceOne with non-words returned " + d1.size() + " words.\n";
            
            d1 = new ArrayList<String>();
            
            feedback += "** TextStyleInfo 4: deletions list size... ";
            nw.deletions("makers", d1, true);
            feedback += "deletions returned " + d1.size() + " words.\n";

            feedback += "** TextStyleInfo 5: deletions words returned... ";
            ...
            feedback += "\n** TextStyleInfo 6: insertions list size... ";
            nw.insertions("or", d1, true);
            feedback += "insertions returned " + d1.size() + " words.\n";

            feedback += "** TextStyleInfo 7: insertions words returned... ";
