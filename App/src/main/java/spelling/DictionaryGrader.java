...
public class DictionaryGrader {
    public static void main(String args[]) {
        ...
        try {
            ...
            feedback += "** TextStyleInfo #1: Adding new word to the LL dictionary...";
            feedback += "addWord returned " + dictLL.addWord("tEst") + ".\n";

            feedback += "** TextStyleInfo #2: Adding a second word...";
            dictLL.addWord("second");
            feedback += "Dictionary size is " + dictLL.size() + ".\n";

            feedback += "** TextStyleInfo #3: Looking up word from first test...";
            feedback += "isWord returned " + dictLL.isWord("teSt") + ".\n";

            Dictionary dictBST = new DictionaryBST();

            feedback += "** TextStyleInfo #4: Adding a new word to the BST dictionary...";
            feedback += "addWord returned " + dictBST.addWord("tEst") + ".\n";
            
            feedback += "** TextStyleInfo #5: Adding second word to BST dictionary...";
            dictBST.addWord("second");
            feedback += "Dictionary size is " + dictBST.size() + ".\n";
            
            feedback += "** TextStyleInfo #6: Retrieving the word from the first test...";
            feedback += "isWord returned " + dictBST.isWord("teSt") + ".\n";


            feedback += "** TextStyleInfo #7: Adding lots of words and retrieving some...";
            ...
            feedback += "** TextStyleInfo #8: Testing non-word in DictLL...";
            feedback += "isWord(soup) returned " + dictLL.isWord("soup") + ".\n";

            feedback += "** TextStyleInfo #9: Testing non-word in DictBST...";
