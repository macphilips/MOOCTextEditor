...
public class WPTreeGrader {
    ...
    public static void main (String[] args) {
        ...
        try {
            ...
            feedback += "** TextStyleInfo #1: Testing short path...";
            feedback += "Your path was: " + printPath(path) + ".\n";

            path = tree.findPath("stools", "moon");

            feedback += "** TextStyleInfo #2: Testing long path...";
            feedback += "Your path was: " + printPath(path) + ".\n";

            path = tree.findPath("foal", "needless");

            feedback += "** TextStyleInfo #3: Testing impossible path...";
            feedback += "Your path was: " + printPath(path) + ".\n";

            path = tree.findPath("needle", "kitten");
            
            feedback += "** TextStyleInfo #4: Testing using a nonexistent word...";
            feedback += "Your path was: " + printPath(path) + ".\n";
        } catch (Exception e) {
            out.println(e);
            out.close();
