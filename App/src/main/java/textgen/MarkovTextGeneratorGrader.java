...
public class MarkovTextGeneratorGrader {
    ...
    public static void main(String[] args) {
        try {
            ...
            feedback += "\n** TextStyleInfo 1: Generating text before training...";
            try {
            ...
            gen.train("");
            feedback += "\n** TextStyleInfo 2: Generating text after training on an empty file...";
            try {
                String s = gen.generateText(20);
                feedback += "No error thrown. ";
            } catch (Exception e) {
            ...
            feedback += "\n** TextStyleInfo #3: Checking requested generator word count...";
            ...
            feedback += "\n** TextStyleInfo #4: Testing specific word counts...";
            feedback += "'I' appeared " + wordCounts.get("I") + " times. ";

            boolean found = true;
            feedback += "\n** TextStyleInfo #5: Checking that every word is used at least once...";
            feedback += "Done. ";

            found = true;
            feedback += "\n** TextStyleInfo 6: Seeing if last word is always followed by first word...";
            feedback += "Done. ";

            feedback += "\n** TextStyleInfo #7: Requesting zero words...";
            ...
            words = res.split("[\\s]+");
            int i = 0;
            feedback += "\n** TextStyleInfo #8: Running train() on a generator that has already been trained...";
            for (String w : words) {
                if (w.equals("I")) {
                    i++;
                }
            ...
            gen.retrain("");
            feedback += "\n** TextStyleInfo #9: Testing retrain()...";
            String s = gen.generateText(20);
